...
### Für Debian basierte Systeme kann der Installer verwendet werden, welcher alles übernimmt.
...
Wenn der Installer erfolgreich durchgelaufen ist, sind **keine weiteren Schritte mehr notwendig**. Viel Spass ;)
